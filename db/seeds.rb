...
Comment1 = Comment.create(body: "Hi world!", post_id: 1)
Comment2 = Comment.create(body: "Wow!", post_id: 1)
Comment3 = Comment.create(body: "You're awesome!", post_id: 2)
Comment4 = Comment.create(body: "Everyone's awesome!", post_id: 2)
Comment5 = Comment.create(body: "I agree!", post_id: 3)
Comment6 = Comment.create(body: "Me too!", post_id: 4)
Comment7 = Comment.create(body: "Ok!", post_id: 5)
